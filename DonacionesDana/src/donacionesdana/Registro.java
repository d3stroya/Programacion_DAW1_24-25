...
public class Registro {
    ...
    public Registro(String email, String contrasenia) {
        this.email = email;
     ...
     */
    private static boolean comprobarLongitudContrasenia(String contrasenia) {
     ...
     */
    private static boolean contieneMayuscula(String contrasenia) {
     ...
     */
    private static boolean contieneMinuscula(String contrasenia) {
        boolean encontrado = false;
        int i = 0;
        int charActual;
     ...
     */
    private static boolean contieneNumero(String contrasenia) {
        boolean encontrado = false;
        int i = 0;
        int charActual;
     ...
     */
    private static boolean contieneCaracterEspecial(String contrasenia) {
        boolean encontrado = false;
        int i = 0;
        int charActual;
     ...
     */
    private static boolean comprobarContrasenia(String contrasenia) {
     ...
     */
    private static String registrarEmail() {
        String email = "";
        int intentos = 5;
     ...
     */
    private static String registrarContrasenia() {
        String contrasenia = "";
        int intentos = 5;
    ...
    public static Usuario registrarUsuario() { 
        ...
        if(!contrasenia.equals("")) {
            ...
            usuario = new Usuario(email, contrasenia);
        }
