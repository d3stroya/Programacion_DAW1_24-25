...
public class Tema09 {
    ...
    public static void main(String[] args) {
        ...
        /* EJEMPLO: Organizar productos de una tienda por categorías utilizando su código */
        System.out.println("\n- EJEMPLO -");
        ...
        String codigo = codigoProducto.trim().substring(3, codigoProducto.length());
        System.out.println(categoria);
        System.out.println(codigo);
        
        if(categoria.equalsIgnoreCase("HOG")) {
            System.out.println("Categoría: HOGAR");
